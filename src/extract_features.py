...
import logger
from . import utils
from src.utils.base_model import dynamic_load
#from utils.parsers import parse_image_lists
from src.utils.io import read_image, list_h5_names
...
class ImageDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        name = self.names[idx]
        image = read_image(Path(self.root) / Path(name), self.conf.grayscale)
